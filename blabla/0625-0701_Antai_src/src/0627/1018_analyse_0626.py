...
# train表分析：
print len(train)    # 12 868 509
# print train['buyer_country_id'].nunique() # 2
print train['buyer_admin_id'].nunique() # 809213
print train['item_id'].nunique() # 2812048
# print train['create_order_time'].nunique()  #
# print train['irank'].nunique()  #
