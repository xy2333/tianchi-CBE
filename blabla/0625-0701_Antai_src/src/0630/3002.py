...
import pandas as pd
# 计算用户最喜欢的商铺
test_path = '/home/kesci/input/data_AE3941/Antai_AE_round1_test_20190626.csv'
...
# 计算第二类
# 得到测试集中每个用户最后一条记录
test_df_last_single = pd.read_csv(test_path, encoding='utf-8').sort_values(['buyer_admin_id','create_order_time']).drop_duplicates('buyer_admin_id',keep='last')
...
result.to_csv("/home/kesci/work/3002.csv")  