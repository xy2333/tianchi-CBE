...
df = pd.read_csv("/home/kesci/work/3006_xx_train_X.csv", encoding='utf-8')
...
result.columns = ['buyer_admin_id','fav_cate'] #ValueError: Length mismatch: Expected axis has 3 elements, new values have 2 elements
result.to_csv("/home/kesci/work/3007.csv")
# 由下面可以验证确实是那五个用户的缺失
