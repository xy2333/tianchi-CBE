...
# attri_path = '../../data/Antai_AE_round1_item_attr_20190625.csv'
...
# attr表分析
# print len(attr_)    # 2416318
# print attr_['item_id'].nunique() # 2416318
# print attr_['cate_id'].nunique() # 4119
# print attr_['store_id'].nunique() # 90783
# print attr_['item_price'].nunique()  # 17932
...
# max:  17932
# train表分析：
# print len(train)    # 10 012 805
# print train['buyer_country_id'].nunique() # 2
# print train['buyer_admin_id'].nunique() # 653593
# print train['item_id'].nunique() # 2406722
# print train['create_order_time'].nunique()  # 2096496
# print train['irank'].nunique()  # 16790
...
# max 16790
# test表分析
print len(test_)    # 10 012 805
# print test_['buyer_country_id'].nunique() # 2
# # print test_['buyer_admin_id'].nunique() # 653593
# # print test_['item_id'].nunique() # 2406722
# # print test_['create_order_time'].nunique()  # 2096496
# print test_.head()
...
# a = unique_xx
# b = unique_yy
# print np.sum(a[:min(len(a), len(b))] == b[:min(len(a), len(b))])  # 0 ： 说明两个国家并没有相同的buyer id 存在
